                                        ...
                                        <div class="thumbnail-slider d-flex">
                                            ...
                                            <c:if test="${not empty product.image2}">
                                                <div class="thumbnail-item"
                                                    ...
                                                    <img src="/images/product/${product.image2}" alt="${product.name}"
                                                        class="img-thumbnail">
                                                    <div class="thumbnail-selected-mask"></div>
                                                </div>
                                            </c:if>
                                            <c:if test="${not empty product.image3}">
                                                <div class="thumbnail-item"
                                                    ...
                                                    <img src="/images/product/${product.image3}" alt="${product.name}"
                                                        class="img-thumbnail">
                                                    <div class="thumbnail-selected-mask"></div>
                                                </div>
                                            </c:if>
                                            <c:if test="${not empty product.image4}">
                                                <div class="thumbnail-item"
                                                    ...
                                                    <img src="/images/product/${product.image4}" alt="${product.name}"
                                                        class="img-thumbnail">
                                                    <div class="thumbnail-selected-mask"></div>
                                                </div>
                                            </c:if>
                                            <c:if test="${not empty product.image5}">
                                                <div class="thumbnail-item"
                                                    ...
                                                    <img src="/images/product/${product.image5}" alt="${product.name}"
                                                        class="img-thumbnail">
                                                    <div class="thumbnail-selected-mask"></div>
                                                </div>
                                            </c:if>
                            ...
                            <ul class="nav nav-tabs" id="productTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="documents-tab" data-bs-toggle="tab"
                                        data-bs-target="#documents" type="button" role="tab">Tài liệu kỹ thuật</button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content p-4 border border-top-0 rounded-bottom" id="productTabContent">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <div class="alert alert-info">
                                                <i class="fas fa-info-circle me-2"></i>Chưa có video cho sản phẩm này
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                ...
                                <div class="tab-pane fade" id="documents" role="tabpanel"
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty product.documentation}">
                                            <div class="document-download p-3 border rounded mb-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="${product.documentation}" class="btn btn-outline-primary">
                                        ...
                                        <c:otherwise>
                                            <div class="alert alert-info">
                                                <i class="fas fa-info-circle me-2"></i>Chưa có tài liệu kỹ thuật cho sản
                                                phẩm này
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
