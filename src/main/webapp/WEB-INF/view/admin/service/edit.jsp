    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                ...
                <meta name="description" content="PhanTech - Chỉnh sửa dịch vụ" />
                <meta name="author" content="PhanTech" />
                <title>Chỉnh sửa dịch vụ - PhanTech</title>
                                        ...
                                        <form action="/admin/service/edit/${service.id}" method="post"
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="detailDesc"
                                                        name="detailDesc">${service.detailDesc}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-text">Chọn hình ảnh mới (để trống nếu không muốn
                                                        thay đổi)</div>
                ...
                <script>
                    tinymce.init({
                        ...
                        plugins: [
                            ...
                            // Premium features
                            'checklist', 'mediaembed', 'casechange', 'formatpainter', 'pageembed', 'a11ycheck',
